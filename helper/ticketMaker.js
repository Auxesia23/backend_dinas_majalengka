const drawTicket = (doc, ticketData, index) => {
    ...
    doc.font('Helvetica-Bold').fontSize(12).fillColor('#56a54f').text(`Rp. ${ticketData.harga}`, doc.page.width - 150, 250 + yOffset, {
        align: 'right'
    })
    ...
    doc.font('Helvetica').fontSize(8).fillColor('#999').text('disparbud@majalengkakab.go.id', 30, doc.page.height - 30)
    doc.text('(0233) 8286543', doc.page.width - 120, doc.page.height - 30)
}
